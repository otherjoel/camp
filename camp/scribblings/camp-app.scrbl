...
friction from common operations when you're ready to write. 
...
You can double click on individual sources in the right-side pane to edit them. (You can select your
preferred editor by clicking @onscreen{File} menu → @onscreen{Preferences…}.)
